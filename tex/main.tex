...
\begin{document}
    ...
    \section{Technical Feasibility}
        ...
        In order to find the characteristic / the working principle of the sensor actual sensors on the board are directly used

        Transducers will be removed from the module and attached to an empty pertinax
        10Vpp 40 kHz sinusoidal signal will be given to the transmitter directly from the signal generator
        Differential signal will be received from the receiver with double probe
        The sent and incoming signal will be compared in frequency and amplitude.

        Both sensors are placed on the pertinax with their dotted legs on the left when viewed from the front.
