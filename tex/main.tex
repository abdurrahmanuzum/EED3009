...
\begin{document}
    ...
    \section{Overview of the Project}
        ...
        \subsection{Project Inputs}
            ...
            \begin{itemize}
                ...
                \item Not emply an MCU or ASIC designed for this particular purpuse.
            \end{itemize}
    ...
    \section{Methodology}
        ...
        \subsection{Sensor Types}
            ...
            \subsubsection{Optical Sensors}
                ...
                \textbf{IR - Triangulation Sensors}
                    ...
                    \begin{figure}[H]\centering
                        \includegraphics[width=\textwidth]{triangulation}
                    \end{figure}
            ...
            \begin{table}[H]\centering
                \begin{tabular}{|c|c|c|}
                    \hline Type & IR & Ultrasonic \\
                    \hline Source & reflected light waves & reflected sound waves \\
                    \hline Applicable Surface & suitable to complex surfaces & not suitable to complex surfaces \\
                    \hline
                \end{tabular}
            \end{table}
    ...
    \subsection{Design Overview / Technical Feasibility}
        ...
        \textbf{BLOCK DIAGRAM HERE MAYBE?}
